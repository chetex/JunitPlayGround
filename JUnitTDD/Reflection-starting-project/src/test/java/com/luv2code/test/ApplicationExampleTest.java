...
public class ApplicationExampleTest {
    ...
    public void createStudentWithoutGradesInit() {
        CollegeStudent studentTwo = appContext.getBean("collegeStudent", CollegeStudent.class);
    ...
    @Test
    public void testReflectionCollegeStudent () {
        // Instance college student
        CollegeStudent collegeStudent = appContext.getBean(CollegeStudent.class);

        // Reflection set element
        ReflectionTestUtils.setField(student, "id", 1);

        ReflectionTestUtils.invokeMethod(student, "getGlobalName");

        assertEquals("Eric1", ReflectionTestUtils.invokeMethod(student, "getGlobalName"));
    }
;}
